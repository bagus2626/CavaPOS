...
class OwnerProductController extends Controller
{
    public function index()
    {
        ...
        $products = PartnerProduct::with('parent_options.options', 'category')
            ...
            ->get();
        return view('pages.owner.products.index', compact('products', 'categories'));
    }

    public function create()
    {
        $categories = Category::where('owner_id', Auth::id())->get();
        return view('pages.owner.products.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Simpan produk utama
            $productCode = 'PRD-' . $owner->id . '-' . strtoupper(uniqid());
            ...
            return redirect()
                ->route('owner.user-owner.products.index')
    ...
    public function edit(PartnerProduct $product)
    {
        ...
        return view('pages.owner.products.edit', compact('data', 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('owner.user-owner.products.index')->with('success', 'Product updated successfully!');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function destroy(PartnerProduct $product)
    {
        ...
        return redirect()->route('owner.user-owner.products.index')->with('success', 'Product deleted successfully!');
    }
}
