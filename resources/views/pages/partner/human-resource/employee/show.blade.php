...
<div class="container employee-show-page"> {{-- tambahkan class page scope --}}
...
.employee-show-page{
  --choco:#8c1000; --soft-choco:#c12814; --ink:#22272b; --muted:#6b7280;
  --paper:#fff; --radius:14px; --shadow:0 6px 20px rgba(0,0,0,.08);
}
...
.employee-show-page .employee-avatar{
  --avatar-size: 200px;  /* default desktop */
...
.employee-show-page .employee-avatar__placeholder{
  ...
  background:#f3f4f6; color:#111827; font-weight:800; font-size:3rem;
}
...
.employee-show-page .employee-name{
  margin:0; font-weight:700; color:var(--ink); font-size:1.35rem; line-height:1.2;
}

/* Badges */
.employee-show-page .badge-status{
  border-radius:999px; padding:.42rem .7rem; font-weight:600; font-size:.85rem;
...
.employee-show-page .btn-outline-choco{
  color:var(--choco); border:1px solid var(--choco); background:transparent;
}
...
.employee-show-page .meta-list dt{
  color:#374151; font-weight:600; width:40%;
  float:left; clear:left; padding:.45rem 0; border-bottom:1px dashed #eef1f4;
}
.employee-show-page .meta-list dd{
  margin-left:40%; color:#111827; padding:.45rem 0; border-bottom:1px dashed #eef1f4;
}
...
.employee-show-page .link-ink:hover{
  color:var(--soft-choco); text-decoration:underline;
}
...
@media (max-width: 992px){
  .employee-show-page .employee-avatar{ --avatar-size: 170px; }
}
@media (max-width: 768px){
  .employee-show-page .employee-hero{
    flex-direction:column; align-items:center; text-align:center;
  }
  .employee-show-page .employee-avatar{ --avatar-size: 150px; }
  .employee-show-page .meta-list dt{ width:48%; }
  .employee-show-page .meta-list dd{ margin-left:48%; }
}
@media (max-width: 576px){
  .employee-show-page .employee-avatar{ --avatar-size: 120px; }
  .employee-show-page .employee-name{ font-size:1.15rem; }
  .employee-show-page .btn-group{ width:100%; }
  .employee-show-page .btn-group .btn{ width:50%; }
}
</style>
