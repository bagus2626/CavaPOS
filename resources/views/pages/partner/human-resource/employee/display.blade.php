        ...
        <tbody>
            @foreach ($employees as $index => $employee)
                <tr data-category="{{ $employee->role }}">
                    ...
                    <td>
                        <a href="{{ route('partner.user-management.employees.show', $employee->id) }}" class="btn btn-sm btn-info">Detail</a>
                        <a href="{{ route('partner.user-management.employees.edit', $employee->id) }}" class="btn btn-sm btn-warning">Edit</a>
