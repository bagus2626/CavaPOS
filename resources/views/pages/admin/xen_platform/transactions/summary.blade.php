                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark">
                            IDR {{ number_format($summary['incoming_amount'] ?? 0) }}</h2>
                    </div>
                </div>
                <div class="text-end">
                    <small class="text-muted d-block">Transactions Count</small>
                    <span class="text-muted fw-semibold">{{ $summary['incoming_count'] ?? 0 }}</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body d-flex justify-content-between align-items-center mt-2">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold text-dark">IDR {{ number_format($summary['outgoing_amount'] ?? 0) }}</h2>
                    </div>
                </div>
                <div class="text-end">
                    <small class="text-muted d-block">Transactions Count</small>
                    <span class="text-muted fw-semibold">{{ $summary['outgoing_count'] ?? 0 }}</span>
                </div>
            </div>
        </div>
    </div>
