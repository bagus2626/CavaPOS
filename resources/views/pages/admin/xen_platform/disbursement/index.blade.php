                            ...
                            <div class="col-12">
                                <div class="card border-top border-4 border">
                                    <div class="card-header border-bottom">
                                        @include('pages.admin.xen_platform.disbursement.filter')
                                    </div>
...
@endsection
@section('modal')
    @include('pages.admin.xen_platform.disbursement.modal')
@endsection
@push('page-scripts')
    <script>
        $.ajaxSetup({
        ...
        function displayData(page = 1, callback = null) {
            ...
            $.ajax({
                url: `{{ route("admin.xen_platform.disbursement.get-data") }}`,
                method: "post",
                data: data_search,
