    ...
    <div class="mobile-filter-modal" id="mobileFilterModal">
        ...
        <div class="filter-modal-content">
            ...
            <div class="filter-modal-body">
                {{-- Loop Outlet dihapus karena staff hanya punya 1 outlet,
                tapi struktur body modal tetap dipertahankan agar tidak merusak layout --}}
            </div>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="text-center">
                            <div class="table-actions">
                                <a href="{{ route('employee.' . $staffRoutePrefix . '.products.edit', $p->id) }}"
...
{{-- FLOATING ADD BUTTON - MOBILE ONLY (Penyesuaian attribute data-outlet dihilangkan) --}}
