...
@php
    // Dapatkan role untuk prefix route dinamis (manager/supervisor)
  ...
  <div class="modern-container">
    <div class="container-modern">
      ...
      <div class="modern-card">
        <form action="{{ route('employee.' . $staffRoutePrefix . '.products.update', $data->id) }}" method="POST" id="productForm">
          @csrf
          @method('PUT')
          ...
          <div class="card-footer-modern">
            <a href="{{ route('employee.' . $staffRoutePrefix . '.products.index') }}" class="btn-cancel-modern">
...
@push('scripts')
  ...
  {{-- 2. Panggil file JS Eksternal (Perlu disesuaikan url fetch-nya di JS jika ada axios) --}}
  <script src="{{ asset('js/employee/staff/product/edit.js') }}"></script>
