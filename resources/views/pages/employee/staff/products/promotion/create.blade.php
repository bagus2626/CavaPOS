    ...
    <div class="modern-container">
        <div class="container-modern">
            ...
            <div class="modern-card">
                <form action="{{ route("employee.{$empRole}.promotions.store") }}" method="POST" id="promotionForm">
                    @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <small class="text-muted d-block mt-1" id="valueHelp">
                                        {{ old('promotion_type') === 'amount' ? __('messages.owner.products.promotions.reduced_fare_example') : __('messages.owner.products.promotions.percentage_example') }}
                                    </small>
    ...
    (function () {
        ...
        function applyTypeUI() {
            ...
            if (t === 'percentage') {
                ...
                valInput.style.paddingLeft = 'var(--spacing-lg)'; valInput.style.paddingRight = '3rem';
        ...
        function updateDayStatuses() {
            ...
            dayCheckboxes.forEach(cb => {
                ...
                if (cb.checked) { checkedCount++; if (statusLabel) statusLabel.textContent = window.promoLang.activeStatus; }
                else { if (statusLabel) statusLabel.textContent = window.promoLang.inactiveStatus; }
            });
        ...
        dayCheckboxes.forEach(cb => cb.addEventListener('change', updateDayStatuses));
        updateDayStatuses();
