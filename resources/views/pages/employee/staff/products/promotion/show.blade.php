            ...
            <div class="detail-hero-header">
                ...
                <div class="detail-hero-info">
                    ...
                    <div class="detail-hero-badges">
                        @if($isActive)
                            <span class="badge-modern badge-success">{{ __('messages.owner.products.promotions.active') }}</span>
                        @else
                            <span class="badge-modern badge-secondary">{{ __('messages.owner.products.promotions.inactive') }}</span>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="modern-card">
            <div class="card-body-modern">
                ...
                <div class="detail-info-grid">
                    <div class="detail-info-group">
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.promo_code') }}</div>
                            <div class="detail-info-value">{{ $promo->promotion_code ?? '—' }}</div>
                        </div>
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.promo_name') }}</div>
                            <div class="detail-info-value">{{ $promo->promotion_name ?? '—' }}</div>
                        </div>
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.promo_type') }}</div>
                    ...
                    <div class="detail-info-group">
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.value') }}</div>
                            <div class="detail-info-value text-success">
                                <span>{{ $valueLabel }}</span>
                            </div>
                        </div>
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.is_use_expiry') }}</div>
                            <div class="detail-info-value">
                        ...
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.active_day') }}</div>
                            <div class="detail-info-value">
                                @if($isEveryDay)
                ...
                <div class="detail-info-grid">
                    <div class="detail-info-group">
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.start_date') }}</div>
                            <div class="detail-info-value">
                    ...
                    <div class="detail-info-group">
                        <div class="detail-info-item">
                            <div class="detail-info-label">{{ __('messages.owner.products.promotions.end_date') }}</div>
                            <div class="detail-info-value">
                ...
                <div class="action-buttons-group">
                    <a href="{{ route("employee.{$empRole}.promotions.edit", $promo->id) }}" class="btn-action btn-action-edit">
                        <span class="material-symbols-outlined">edit</span>
                        {{ __('messages.owner.products.promotions.edit') }}
                    </a>
                    <form action="{{ route("employee.{$empRole}.promotions.destroy", $promo->id) }}" method="POST" class="d-inline-block" id="deleteForm">
                        @csrf
                        @method('DELETE')
...
.btn-action {
    ...
    border: 1px solid rgba(0,0,0,.10); cursor: pointer; font-size: 0.95rem; background: #fff;
}
.btn-action .material-symbols-outlined { font-size: 1.25rem; }
.btn-action-edit { color: #333; border-color: rgba(0,0,0,.10); }
.btn-action-edit:hover { background: #f8f9fa; color: #333; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(0,0,0,.08); }
.btn-action-delete { border-color: rgba(174,21,4,.25); color: #ae1504; }
.btn-action-delete:hover { background: rgba(174,21,4,.05); transform: translateY(-1px); box-shadow: 0 4px 12px rgba(174,21,4,.15); }
