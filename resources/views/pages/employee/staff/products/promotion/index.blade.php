        ...
        <div class="container-modern">
            ...
            <div class="modern-card mb-4 only-desktop">
                <div class="card-body-modern" style="padding: var(--spacing-lg) var(--spacing-xl);">
                    <form method="GET" action="{{ route("employee.{$empRole}.promotions.index") }}" id="promotionFilterForm">
                        <div class="table-controls">
                            <div class="search-filter-group">
                                <div class="input-wrapper" style="flex: 1; max-width: 400px;">
                                    ...
                                    <input type="text" name="q" id="promotionSearchInput"
                                        value="{{ request('q') }}" class="form-control-modern with-icon"
                            ...
                            <a href="{{ route("employee.{$empRole}.promotions.create") }}" class="btn-modern btn-primary-modern">
            ...
            @include('pages.employee.staff.products.promotion.display')
