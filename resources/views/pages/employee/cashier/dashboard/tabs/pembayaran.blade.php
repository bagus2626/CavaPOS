                        ...
                        <li class="rounded-xl border border-choco/10 p-3 hover:bg-soft-choco/5"
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-sm font-semibold text-gray-900 leading-tight">
                                        ...
                                        @if ($i->payment_method === 'QRIS' && $i->order_status === 'EXPIRED')
                                            <span
                                                class="inline-block ml-1 px-2 py-0.5 text-xs font-medium text-white bg-red-500 rounded-md">
                                                Expired QRIS
                                            </span>
                                        @endif
                                    </p>
                                ...
                                <div
                                    ...
                                    data-detail-btn
                                    data-order-id="{{ $i->id }}"
                                    class="flex-1 sm:flex-none text-center text-sm px-3 py-1.5 rounded-lg
                                    ...
                                    <button type="button"
                                        ...
                                        class="flex-1 sm:flex-none text-sm px-3 py-1.5 rounded-lg
                                            bg-soft-choco text-white
                                            hover:bg-soft-choco/90
                                            focus:ring-2 focus:ring-soft-choco/40">
                                        Bayar
                                    </button>
                                    ...
                                    <form action="{{ route('employee.cashier.order.soft-delete', $i->id) }}"
                                        ...
                                        <button type="button"
                                                ...
                                                class="p-2 rounded-lg border border-red-200 text-red-500
                                                    hover:bg-red-50 focus:ring-2 focus:ring-red-200">
