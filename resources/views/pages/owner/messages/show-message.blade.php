...
@section('content')
    <div class="modern-container">
        <div class="container-modern">
            <!-- Back Button -->
            {{-- <a href="{{ route('owner.user-owner.messages.index') }}" class="back-button">
        ...
        $(document).ready(function () {
            ...
            function renderAttachments(attachments) {
                ...
                attachments.forEach(function (attachment) {
                    ...
                    // Generate proper URL menggunakan Laravel asset helper
                    const fileUrl = '/storage/' + attachment.file_path;

                    const attachmentHtml = `
                <a href="${fileUrl}" target="_blank" class="attachment-item" download="${attachment.file_name}">
