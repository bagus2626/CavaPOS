...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('owner.user-owner.products.index') }}" class="btn btn-secondary mb-3">
        ...
        <div class="card">
            ...
            <form action="{{ route('owner.user-owner.products.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <!-- Basic Product Info -->
...
@section('scripts')
{{-- @include('pages.owner.products.create') --}}
<script>
