        ...
        <tbody>
            @foreach ($products as $index => $product)
                <tr data-category="{{ $product->category_id }}">
                    ...
                    <td>
                        <a href="{{ route('owner.user-owner.master-products.show', $product->id) }}" class="btn btn-sm btn-info">Detail</a>
                        <a href="{{ route('owner.user-owner.master-products.edit', $product->id) }}" class="btn btn-sm btn-warning">Edit</a>
