                                                ...
                                                <select name="product_category" id="product_category"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ old('product_category', $data->category_id) == $category->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group-modern">
                                            ...
                                            <div class="input-wrapper">
                                                ...
                                                <input type="text" name="price" id="price"
                                                    ...
                                                    value="{{ old('price', number_format($data->price, 0, ',', '.')) }}"
                                                    required>
                                            </div>
                                            @error('price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <label class="checkbox-modern mt-2" for="apply_price_all_outlets">
                                                ...
                                                <input type="checkbox" id="apply_price_all_outlets"
                                                    name="apply_price_all_outlets" value="1"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-modern">
                                                ...
                                                <select name="promotion_id" id="promotion_id"
                                                    ...
                                                    @foreach ($promotions as $promo)
                                                        <option value="{{ $promo->id }}"
                                                            {{ (string) $selectedPromoId === (string) $promo->id ? 'selected' : '' }}>
                                                            {{ $promo->promotion_name }}
                                                            (@if ($promo->promotion_type === 'percentage')
                                                                {{ number_format($promo->promotion_value, 0, ',', '.') }}%
                                                                Off
                                                            @else
                                                                Rp
                                                                {{ number_format($promo->promotion_value, 0, ',', '.') }}
                                            ...
                                            <label class="checkbox-modern mt-2" for="apply_promotion_all_outlets">
                                                ...
                                                <input type="checkbox" id="apply_promotion_all_outlets"
                                                    name="apply_promotion_all_outlets" value="1"
                        ...
                        <div id="menu-options-container" class="menu-options-container">
                            @foreach ($data->parent_options as $pIndex => $parent)
                                <div class="menu-option-card" data-menu-index="{{ $pIndex + 1 }}">
                                    <input type="hidden" name="menu_options[{{ $pIndex + 1 }}][parent_id]"
                                        value="{{ $parent->id }}">

                                    <div class="menu-option-header">
                                        <div class="menu-option-title">
                                            <span class="material-symbols-outlined">tune</span>
                                            <h4>{{ __('messages.owner.products.master_products.category_option_header') }}
                                                {{ $pIndex + 1 }}</h4>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="form-group-modern">
                                                <label
                                                    class="form-label-modern">{{ __('messages.owner.products.master_products.menu_name_label') }}</label>
                                                <input type="text" name="menu_options[{{ $pIndex + 1 }}][name]"
                                                    value="{{ $parent->name }}" class="form-control-modern" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group-modern">
                                                <label
                                                    class="form-label-modern">{{ __('messages.owner.products.master_products.menu_description_label') }}</label>
                                                <input type="text"
                                                    name="menu_options[{{ $pIndex + 1 }}][description]"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group-modern">
                                                <label
                                                    class="form-label-modern">{{ __('messages.owner.products.master_products.provision_type_label') }}</label>
                                                <div class="select-wrapper">
                                                    <select name="menu_options[{{ $pIndex + 1 }}][provision]"
                                                        class="form-control-modern provision-select"
                                                        data-index="{{ $pIndex + 1 }}" onchange="provisionOption(this)"
                                                        required>
                                                        <option value="">
                                                            {{ __('messages.owner.products.master_products.select_provision_placeholder') }}
                                                        </option>
                                                        <option value="OPTIONAL"
                                                            {{ $parent->provision === 'OPTIONAL' ? 'selected' : '' }}>
                                                            {{ __('messages.owner.products.master_products.provision_optional') }}
                                                        </option>
                                                        <option value="OPTIONAL MAX"
                                                            {{ $parent->provision === 'OPTIONAL MAX' ? 'selected' : '' }}>
                                                            {{ __('messages.owner.products.master_products.provision_optional_max') }}
                                                        </option>
                                                        <option value="MAX"
                                                            {{ $parent->provision === 'MAX' ? 'selected' : '' }}>
                                                            {{ __('messages.owner.products.master_products.provision_max') }}
                                                        </option>
                                                        <option value="EXACT"
                                                            {{ $parent->provision === 'EXACT' ? 'selected' : '' }}>
                                                            {{ __('messages.owner.products.master_products.provision_exact') }}
                                                        </option>
                                                        <option value="MIN"
                                                            {{ $parent->provision === 'MIN' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-2 provision-value-col" id="jumlah-options-{{ $pIndex + 1 }}"
                                            ...
                                            <div class="form-group-modern">
                                                <label
                                                    class="form-label-modern">{{ __('messages.owner.products.master_products.amount_label') }}</label>
                                                <input type="number"
                                                    name="menu_options[{{ $pIndex + 1 }}][provision_value]"
                                                    class="form-control-modern" min="0"
                                                    value="{{ $parent->provision_value }}"
                                                    {{ $parent->provision === 'OPTIONAL' ? 'disabled' : '' }} required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="options-list" id="options-container-{{ $pIndex + 1 }}">
                                        @foreach ($parent->options as $oIndex => $option)
                                            <div class="option-item">
                                                <input type="hidden"
                                                    name="menu_options[{{ $pIndex + 1 }}][options][{{ $oIndex + 1 }}][option_id]"
                                                    value="{{ $option->id }}">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-5">
                                                        <div class="form-group-modern">
                                                            <label
                                                                class="form-label-modern">{{ __('messages.owner.products.master_products.option_name_label') }}</label>
                                                            <input type="text"
                                                                name="menu_options[{{ $pIndex + 1 }}][options][{{ $oIndex + 1 }}][name]"
                                                                value="{{ $option->name }}" class="form-control-modern"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group-modern">
                                                            <label
                                                                class="form-label-modern">{{ __('messages.owner.products.master_products.option_price_label') }}</label>
                                                            <div class="input-wrapper">
                                                                <span class="input-icon">Rp</span>
                                                                <input type="number"
                                                                    name="menu_options[{{ $pIndex + 1 }}][options][{{ $oIndex + 1 }}][price]"
                                                                    value="{{ $option->price }}"
                                                                    class="form-control-modern with-icon" min="0"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group-modern">
                                                            <label
                                                                class="form-label-modern">{{ __('messages.owner.products.master_products.option_description_label') }}</label>
                                                            <input type="text"
