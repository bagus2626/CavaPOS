...
function deleteProduct(productId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/owner/user-owner/products/${productId}`;
...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('owner.user-owner.products.create') }}" class="btn btn-primary mb-3">Add Product</a>
        <div class="mb-3">
        ...
        @endif
        @include('pages.owner.products.display')
    </div>
</section>
@endsection
