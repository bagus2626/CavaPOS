...
<div class="container mt-4">
    <h1>Edit Category</h1>
    <form method="POST" action="{{ route('owner.user-owner.categories.update', $category) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('owner.user-owner.categories.index') }}" class="btn btn-secondary mt-2">Back</a>
    </form>
</div>
