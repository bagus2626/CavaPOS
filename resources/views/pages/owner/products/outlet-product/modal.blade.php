        ...
        <form id="outletProductQuickAddForm" method="POST" action="{{ route('owner.user-owner.outlet-products.store') }}"
            ...
            <div class="modal-body" style="padding: var(--spacing-lg);">
                ...
                <div class="form-group-modern">
                    ...
                    <div class="select-wrapper">
                        <select id="qp_category_id" name="category_id" class="form-control-modern" required>
                            <option value="all">
                                {{ __('messages.owner.products.outlet_products.all_category_dropdown') }}</option>
                    ...
                    <div class="invalid-feedback">
                        {{ __('messages.owner.products.outlet_products.select_category_first') }}</div>
                </div>
                ...
                <div class="form-group-modern" id="qp_quantity_group">
                    ...
                    <input type="number" min="0" step="1" id="qp_quantity" name="quantity"
                        class="form-control-modern" value="0" placeholder="0" required>
                    <small
                ...
                <div class="form-group-modern">
                    ...
                    <div class="select-wrapper">
                        <select id="qp_is_active" name="is_active" class="form-control-modern">
                            ...
                            <option value="0">{{ __('messages.owner.products.outlet_products.inactive') }}
                            </option>
                        </select>
                        <span class="material-symbols-outlined select-arrow">expand_more</span>
                    </div>
