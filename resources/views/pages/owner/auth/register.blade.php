                ...
                <div class="w-full max-w-lg px-4 sm:px-6 relative z-10">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden relative">
                        ...
                        <div class="px-5 sm:px-6 pt-4 sm:pt-5 pb-2 text-center relative">
                            <h1 class="text-xl sm:text-2xl font-bold text-[#991b1b]">Daftar Owner</h1>
                            <p class="mt-0.5 text-[11px] sm:text-xs text-gray-600">
                                Kelola bisnis dengan mudah melalui
                        ...
                        <form method="POST" action="{{ route('owner.register.store') }}"
                            ...
                            <div class="mt-4">
                                <label for="name"
                                    class="block text-[11px] sm:text-xs font-semibold text-gray-700 mb-1">Nama
                                    Lengkap</label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-2.5 sm:left-3 flex items-center text-[#b91c1c]">
                                ...
                                @error('name')
                                    <span
                                        class="text-red-600 text-[10px] sm:text-xs mt-0.5 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-3">
                                <label for="email"
                                    class="block text-[11px] sm:text-xs font-semibold text-gray-700 mb-1">Email</label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-2.5 sm:left-3 flex items-center text-[#b91c1c]">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 sm:h-4 sm:w-4"
                            ...
                            <div class="mt-3">
                                <label for="phone_number"
                                    class="block text-[11px] sm:text-xs font-semibold text-gray-700 mb-1">Nomor
                                    Telepon</label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-2.5 sm:left-3 flex items-center text-[#b91c1c]">
                            ...
                            <div class="mt-3">
                                <label for="password"
                                    class="block text-[11px] sm:text-xs font-semibold text-gray-700 mb-1">Password</label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-2.5 sm:left-3 flex items-center text-[#b91c1c]">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 sm:h-4 sm:w-4"
                            ...
                            <div class="mt-3">
                                <label for="password_confirmation"
                                    class="block text-[11px] sm:text-xs font-semibold text-gray-700 mb-1">Konfirmasi
                                    Password</label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-2.5 sm:left-3 flex items-center text-[#b91c1c]">
                                    ...
                                    <input id="password_confirmation" type="password" name="password_confirmation"
                                        required autocomplete="new-password" placeholder="Masukkan password kembali"
                                        class="block w-full pl-8 sm:pl-9 pr-9 sm:pr-10 py-1.5 sm:py-2 text-xs sm:text-sm rounded-lg border-2 border-red-100 bg-red-50/30
                                               focus:border-[#dc2626] focus:bg-white focus:ring-2 focus:ring-[#dc2626]/10 
                                               transition-all duration-300 placeholder:text-gray-400 text-gray-800" />
                            ...
                            {{-- Footer --}}
                            <div
                                class="px-6 sm:px-8 pb-4 sm:pb-6 text-center border-t border-red-100 pt-3 sm:pt-5 relative">
