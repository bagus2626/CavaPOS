...
@section('content')
    <div class="container-fluid owner-emp-edit px-4 py-3">{{-- tambahkan class page-scope --}}
            ...
            <div class="card-body">
                ...
                <form action="{{ route('owner.user-owner.employees.update', $employee) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="role" id="role" class="form-control @error('role') is-invalid @enderror"
                                required>
                                <option value="">{{ __('messages.owner.user_management.employees.select_status') }}
                                </option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="username" id="username"
                                    ...
                                    value="{{ old('username', $employee->user_name) }}" required minlength="3"
                                    maxlength="30" pattern="^[A-Za-z0-9._-]+$" placeholder="contoh: budi.setiawan"
                                    autocomplete="user_name" autocapitalize="none" spellcheck="false"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                value="{{ old('email', $employee->email) }}" placeholder="name@company.com" required
                            ...
                            <div id="imagePreviewWrapper" class="mt-2 {{ $employee->image ? '' : 'd-none' }}">
                                <div class="position-relative" style="width: 180px;">
                                    <img id="imagePreview"
                                        ...
                                        alt="Image preview" class="img-thumbnail rounded w-100 h-auto">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="password"
                                class="form-label">{{ __('messages.owner.user_management.employees.password_optional') }}</label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="password_confirmation"
                                class="form-label">{{ __('messages.owner.user_management.employees.password_confirmation') }}</label>
                            <div class="input-group">
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="form-control @error('password_confirmation') is-invalid @enderror"
                                    minlength="8" autocomplete="new-password" placeholder="Ulangi password jika diisi">
    ...
    <button type="submit" 
            class="btn btn-choco">{{ __('messages.owner.user_management.employees.update') }}</button>
</div>
    ...
    <style>
        ...
        .owner-emp-edit .card-title {
            color: var(--ink);
            font-weight: 600;
        }

        /* Alerts */
        .owner-emp-edit .alert {
            border-left: 4px solid var(--choco);
            border-radius: 10px;
        }

        .owner-emp-edit .alert-danger {
            background: #fff5f5;
            border-color: #fde2e2;
            color: #991b1b;
        }

        .owner-emp-edit .alert-success {
            background: #f0fdf4;
            border-color: #dcfce7;
            color: #166534;
        }
        ...
        .owner-emp-edit #btnCheckUsername .spinner-border {
            margin-left: .35rem;
        }

        /* Username status badge */
        .owner-emp-edit #usernameStatus .badge {
            border-radius: 999px;
            padding: .28rem .6rem;
            font-weight: 600;
        }

        .owner-emp-edit #usernameStatus .bg-success {
            background: #ecfdf5 !important;
            color: #065f46 !important;
            border: 1px solid #a7f3d0;
        }

        .owner-emp-edit #usernameStatus .bg-danger {
        ...
        /* Switch */
        .owner-emp-edit .form-check-input:checked {
            background-color: var(--choco);
            border-color: var(--choco);
        }

        .owner-emp-edit .form-check-input:focus {
            box-shadow: 0 0 0 .2rem rgba(140, 16, 0, .15);
        ...
        /* Buttons – brand */
        .owner-emp-edit .btn-choco {
            background: var(--choco);
            border-color: var(--choco);
            color: #fff;
        }

        .owner-emp-edit .btn-choco:hover {
            background: var(--soft-choco);
            border-color: var(--soft-choco);
        }

        .owner-emp-edit .btn-outline-choco {
            color: var(--choco);
            border-color: var(--choco);
        }

        .owner-emp-edit .btn-outline-choco:hover {
            color: #fff;
            background: var(--choco);
            border-color: var(--choco);
        }
        ...
        .owner-emp-edit .btn-primary {
            background: var(--choco);
            border-color: var(--choco);
        }

        .owner-emp-edit .btn-primary:hover {
            background: var(--soft-choco);
            border-color: var(--soft-choco);
        }

        .owner-emp-edit .btn-secondary {
            color: var(--choco);
            background: #fff;
            border-color: var(--choco);
        }

        .owner-emp-edit .btn-secondary:hover {
            color: #fff;
            background: var(--choco);
            border-color: var(--choco);
        }
        ...
        /* Spacing gap untuk button group */
.owner-emp-edit .d-flex.gap-2 {
    gap: 0.75rem !important;
}

.owner-emp-edit .d-flex.gap-2 > .btn {
    min-width: 100px;
            ...
            if (isActive) {
                isActive.addEventListener('change', function() {
                    const label = document.querySelector(
                            'label[for="is_active"] + .form-check .form-check-label') ||
