    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="space-x-4">
                        <a href="{{ route('owner.login') }}" class="ml-4 text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                            Login
                        </a>
                        @if (Route::has('register'))
                            <a href="{{ route('owner.register') }}" class="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                                Register
                            </a>
                        @endif
                    </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <!-- Dark Mode Switch -->
                ...
                <div class="space-y-1 px-4">
                    <a href="{{ route('owner.login') }}" class="block text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        Login
                    </a>
                    @if (Route::has('register'))
                        <a href="{{ route('owner.register') }}" class="block text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                            Register
                        </a>
                    @endif
                </div>
