...
<div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="d-none d-md-inline">Partner User</span>
                </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="{{ route('partner.dashboard') }}" class="brand-link bg-gradient-primary">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Partner User</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <a href="{{ route('partner.dashboard') }}" class="nav-link @if(Route::is('partner.dashboard')) active @endif">
                    ...
                    <li class="nav-item {{ Route::is($employeeRoutes) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('partner.user-management.employees.index') }}" class="nav-link {{ Route::is('partner.user-management.employees.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Route::is($productRoutes, $categoryRoutes) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('partner.products.index') }}" class="nav-link {{ Route::is('partner.products.*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>All Products</p>
                                </a>
                            </li>
